    ...
    <Drawer>
      ...
      <DrawerContent>
        <div className='container max-w-6xl mx-auto py-12'>
          ...
          {blogs.length ? (
            <div className='text-2xl font-creteRound mt-8'>{blogs.length} Results found.</div>
          ) : null}
          ...
          <div className='flex flex-col space-y-2 mt-4'>
            <div className='flex items-center gap-2'>
              <DrawerTitle className='font-creteRound text-2xl'>
          ...
          <div className='flex flex-col space-y-2 mt-4'>
            <div className='flex items-center gap-2'>
              <DrawerTitle className='font-creteRound text-2xl'>See posts by tags</DrawerTitle>
              <Minus />
              <Link href={'/tags'}>
                <DrawerClose className='text-blue-500 underline hover:opacity-90'>
                  See all
